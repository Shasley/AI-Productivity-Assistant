  ...
  head: () => ({
    meta: [
      ...
      { title: "Workplace AI — Productivity Assistant" },
      {
        name: "description",
        content:
          "AI productivity suite for professionals: smart emails, meeting summaries, task plans, research and chat.",
      },
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b3eab56a-3332-4f89-bf7f-d7d7ff50aa9e/id-preview-a72c70a1--d691020d-98d2-4c37-af59-2c5e09ed7cb0.lovable.app-1780572722773.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b3eab56a-3332-4f89-bf7f-d7d7ff50aa9e/id-preview-a72c70a1--d691020d-98d2-4c37-af59-2c5e09ed7cb0.lovable.app-1780572722773.png" },
          ...
          <div className="flex flex-1 flex-col">
            <header className="sticky top-0 z-10 flex h-14 items-center gap-3 border-b border-border bg-background/80 px-4 backdrop-blur">
              ...
              <div className="text-sm font-medium text-muted-foreground">
                Workplace AI Productivity Assistant
              </div>
            </header>
